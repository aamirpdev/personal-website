...
public class JdbcUtil {
    ...
    public static boolean validateUser(String username, String password) throws Exception {
        ResultSet resultSet = JdbcUtil.inquire("select * from test_user where username='" + username+"'");
     ...
     * @param username The user's username input.
     * @param password The user's password input.
     * @return The boolean indicates that whether the user has been inserted properly.
     * @throws Exception Exception when doing sql statement.
     */
    public static boolean insertUser(String username, String password) throws Exception {
        boolean isUserAlreadyRegistered = validateUser(username, password);
        if (isUserAlreadyRegistered){
            return false;
        }
        else {
            PreparedStatement st = connection.prepareStatement("INSERT INTO test_user (username, password) VALUES (?, ?)");
