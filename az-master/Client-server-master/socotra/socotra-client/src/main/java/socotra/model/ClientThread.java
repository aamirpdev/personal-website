...
public class ClientThread extends Thread {
     ...
     */
    public ClientThread(String serverName, LoginModel loginModel, RegistrationModel registrationModel, String username,
                        String password, int connectionDataType) {
...
//            System.setProperty("javax.net.debug", "ssl,handshake");
    ...
    public void run() {
        try {
            ...
            registrationModel.setErrorType(0);
                    ...
                    case -1:
                        if (!connectionData.getValidated()) {
                            if (connectionDataType == 0){
                                ...
                                registrationModel.setErrorType(3);
                            }
                            endConnection();
                        }
                        ...
                        synchronized (registrationModel) {
                            registrationModel.notify();
                        }
                        break;
            ...
            registrationModel.setErrorType(1);
            e.printStackTrace();
